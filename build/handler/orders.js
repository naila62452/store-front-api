    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, store.addProduct(products.quantity, products.order_id, products.product_id)];
            case 1:
                product = _a.sent();
                res.json(products);
                return [2 /*return*/];
        ...
        switch (_a.label) {
            case 0:
                try {
                    ...
                    res.status(401);
                    res.send("Access denied, token is not correct " + err);
                }
                return [4 /*yield*/, store.getCurrentOrder(req.params.id)];
            case 1:
                order = _a.sent();
                res.json(order);
                return [2 /*return*/];
