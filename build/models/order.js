...
var OrderStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        sql = 'INSERT INTO orders (status, user_id, product_id, quantity) VALUES ($1, $2, $3, $4)';
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Can not add orders " + err_1);
    ...
    OrderStore.prototype.addProduct = function (quantity, orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, connection, result, order, err_2, sql, conn, result, order, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Can not find order " + err_4);
                    case 4: return [2 /*return*/];
                }
            });
        });
